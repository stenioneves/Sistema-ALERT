                ...
                <!-- top nav -->
              	...
              	<!-- entrar a logo-->
                    ...
                    <ul class="nav navbar-nav">
                     <!--  <li>
                        <a href="senha.html"><i class="glyphicon glyphicon-home"></i> </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="#postModal" role="button" data-toggle="modal"><i class="glyphicon glyphicon-plus"></i> </a>
                      </li>
                      <li>
...
<!-- Form Name -->
<legend>Grupos de moradores mais adequados para a sua localidade!</legend>

<!-- Select Multiple -->
<div class="form-group">
  <label class="col-md-4 control-label" for="selectmultiple">Escolha um grupo(teste)</label>
  <div class="col-md-4">
