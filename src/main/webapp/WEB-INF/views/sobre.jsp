                ...
                <!-- top nav -->
              	...
              	<!-- entrar a logo-->
                    ...
                    <ul class="nav navbar-nav">
                      <li>
                        <a href="principal"><i class="glyphicon glyphicon-home"></i> Home</a>
                      </li>
                      <li>
                      <a href=""><i class="glyphicon glyphicon-home"></i> </a>
                      </li>
                      <li>
                        <a href="quemsomos"><i class="glyphicon glyphicon-home"></i> Quem somos</a>
                      </li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a href="alert/">Página Inicial do Alert</a></li>
                ...
                <div class="padding">
                    <div class="full col-sm-9">
                        ...
                        <div class="row">
                          <div class="col-sm-24">
                          <h1>Sobre o Alert</h1>
                           O Alert começou àpartir de uma conversa entre o professor Veloso (Que já não esta mais na faculdade) e eu Camilla Araujo. O objetivo principal é integrar o BPM Social em algum processo humano. Então surgiu a ideia de criar um sistema colaborativoque podesse melhorar o processo e comunicação entre as possíveis vitimas de desastres naturais, e até mesmo ajudar na provenção de tais problemas.
Atravéz de uma área comum de publicação será possível o compartilhamento de avisos e alertas para que mais pessoas possam receber avisos e saber sobre problemas de seus bairros. Com a Ajuda do Stenio Neves o Alert cresceu e chegou onde estamos. <br>
Vamos conhecer!!!
