                          ...
                          <div class="col-sm-14">
                               ...
                               <div class="panel panel-default">
									...
									<div class="form-group">
									  ...
									  <div class="col-md-6">
									  <input id="textinput" name="bairro" type="text" placeholder="Digite seu Bairro" class="form-control input-md" required="">
									...
									<!-- Text input-->
									<div class="form-group">
									  <label class="col-md-4 control-label" for="checkboxes">NÍVEL DE RISCO BAIRRO </label>
									  <div class="col-md-4">
									    ...
									    <label class="checkbox-inline" for="checkboxes-1">
									      <input type="checkbox" name="nivelRiscoBairro" id="checkboxes-1" value="MEDIO">
									      Medio
									    </label>
